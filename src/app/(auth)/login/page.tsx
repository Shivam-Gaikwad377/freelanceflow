      ...
      <div className="flex flex-col items-center justify-center min-h-full">
        ...
        <div className="w-full max-w-110 bg-surface-container-lowest rounded-lg border border-outline-variant p-xl shadow-level-3 relative z-10 flex flex-col backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-md">
            <button
              className="flex-1 flex justify-center items-center gap-sm py-2.5 px-md bg-surface-container-lowest hover:bg-surface-container-low border border-outline-variant text-on-surface font-label-md text-label-md rounded-lg transition-colors duration-200"
              type="button"
            >
              <svg
                className="w-5 h-5"
