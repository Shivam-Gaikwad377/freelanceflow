              ...
              <div className="space-y-md">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
                  <div>
                    ...
                    <input
                      className="w-full px-4 py-2 rounded-lg bg-surface-container-lowest input-border border font-body-md text-body-md text-on-surface focus:ring-primary/20 focus:border-primary "
                      type="password"
                      placeholder="••••••••"
