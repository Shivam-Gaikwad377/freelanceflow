  ...
  return (
    <>
      <nav className="hidden md:flex flex-col p-md w-64 h-screen bg-surface-container-lowest border-r border-outline-variant fixed left-0 top-0 z-20">
        ...
        <button className="w-full bg-primary text-on-primary py-3 rounded-lg mb-8 font-label-md hover:bg-surface-tint transition-colors shadow-[0_4px_12px_rgba(70,72,212,0.2)]">
          + New Project
        </button>
