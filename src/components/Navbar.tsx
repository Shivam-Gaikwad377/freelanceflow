            ...
            <nav className="bg-surface/80 dark:bg-surface/80 fixed top-4 inset-x-4 max-w-container-max mx-auto backdrop-blur-md border border-outline-variant/30 shadow-lg z-50 rounded-full h-20 flex items-center px-gutter transition-all duration-300 entrance">
                <div className="flex justify-between items-center w-full">
                    ...
                    <div className="flex items-center gap-md">
                        <button className="hidden md:block font-body-md text-body-md text-primary hover:opacity-90 transition-opacity active:scale-95 duration-200 py-2 px-4 rounded-full">
                            Login
                        </button>
                        <button className="bg-primary text-on-primary font-label-md text-label-md py-3 px-6 rounded-full hover:opacity-90 transition-opacity active:scale-95 duration-200 soft-shadow">
                            Get Started
                        </button>
                    </div>
                </div>
